...
class ProvidersTest < ApplicationSystemTestCase
  ...
  test "creating a Provider" do
    ...
    fill_in "Celphone", with: @provider.celphone
    fill_in "Company", with: @provider.company
    fill_in "Name contact", with: @provider.name_contact
    fill_in "Type providers", with: @provider.type_providers
    fill_in "Users", with: @provider.users_id
