...
class ToolsTest < ApplicationSystemTestCase
  ...
  test "creating a Tool" do
    ...
    fill_in "Amount storage", with: @tool.amount_storage
    fill_in "Date acquistion", with: @tool.date_acquistion
    fill_in "Tools brands", with: @tool.tools_brands
    fill_in "Tools models", with: @tool.tools_models
    fill_in "Tools name", with: @tool.tools_name
